...
# ============================================================
# build_faiss_index_igd.py
# Input  : MinIO → knowledge-base/knowledge_base_igd.json
# Output : MinIO → models/scenario2/faiss_index_igd.index
#                  models/scenario2/chunks_igd.pkl
# ============================================================
...
FAISS_KEY  = "scenario2/faiss_index_igd.index"
CHUNKS_KEY = "scenario2/chunks_igd.pkl"
...
print("📂 Chargement de la Knowledge Base IGD depuis MinIO...")
